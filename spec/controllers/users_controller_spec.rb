...
describe UsersController do
  ...
  let(:valid_attributes) { { "email" => "test@test.com", "password" => "abba123456", "password_confirmation" => "abba123456" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      ...
      it "re-renders the 'new' template" do
        # Trigger the behavior that occurs when invalid params are submitted
        User.any_instance.stub(:save).and_return(false)
        User.any_instance.stub(:errors).and_return(["has errors"]) # https://github.com/josevalim/inherited_resources/issues/38
        post :create, {:user => { "email" => "invalid value" }}, valid_session
